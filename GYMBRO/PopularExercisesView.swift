...
struct PopularExercisesView: View {
    @StateObject private var viewModel = PopularExercisesViewModel()
                ...
                if viewModel.isLoading {
                    ...
                    List {
                        ForEach(viewModel.exercises) { exercise in
                            PopularExerciseRowView(exercise: exercise, viewModel: viewModel)
                                .onTapGesture {
...
// MARK: - Exercise Row View for Popular Exercises
struct PopularExerciseRowView: View {
    let exercise: Exercise
    let viewModel: PopularExercisesViewModel
